...
class MovieServiceResponseTest {
    ...
    public void should_convert_to_a_movie_with_valid_runtime() throws FormatException {
        ...
        final var expectedMovie = new Movie("id", "title", Duration.ofMinutes(50), "plot", "https://m.media-amazon.com/images/M/MV5BMjI0MDMzNTQ0M15BMl5BanBnXkFtZTgwMTM5NzM3NDM@._V1_SX300.jpg");
    ...
    public void should_not_convert_to_a_movie_with_invalid_runtime(String runtime) {
        final var movieServiceResponse = new MovieServiceResponse("id", "title", runtime, "plot","https://m.media-amazon.com/images/M/MV5BMjI0MDMzNTQ0M15BMl5BanBnXkFtZTgwMTM5NzM3NDM@._V1_SX300.jpg");
