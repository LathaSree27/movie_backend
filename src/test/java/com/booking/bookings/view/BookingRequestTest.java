...
public class BookingRequestTest {
    ...
    public void should_not_allow_seat_booking_for_more_than_maximum() {
        final var showId = 1L;
        final MovieAudience movieAudience = new MovieAudience("customer 1", "992212399");
        int greaterThanMaxSeats = Integer.parseInt(MAX_NO_OF_SEATS_PER_BOOKING) + 1;
        final BookingRequest bookingRequest = new BookingRequest(Date.valueOf("2020-11-06"), showId, movieAudience, greaterThanMaxSeats);
